...
import { useGetListingDetailQuery } from "@/services/listing.service";
import { Listing } from "@/interfaces/listing";
import { useMemo } from "react";

function Detail({ params }: { params: { id: string } }) {
  const { data } = useGetListingDetailQuery(params.id);
          ...
          <div className="mt-[30px] grid grid-cols-3 xl:grid-cols-4 gap-x-5">
            <div className="col-span-2 xl:col-span-3 space-y-5 pr-[50px]">
              ...
              <div className="flex items-start space-x-[30px]">
                <div className="flex items-start font-semibold leading-6">
                  <Image
                ...
                <div className="flex shrink-0 items-start font-semibold leading-6">
                  <Image
